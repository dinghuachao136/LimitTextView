...
//-(RACSignal *)rac_returnSignal
//{
//    RACSignal *signal = [[[[self.rac_delegateProxy
//                            signalForSelector:@selector(textView:shouldChangeTextInRange:replacementText:)]
//                           reduceEach:^(UITextView *textView,id x,NSString *text) {
//                               return text;
//                           }]
//                          takeUntil:self.rac_willDeallocSignal]
//                         setNameWithFormat:@"%@ -rac_returnSignal", RACDescription(self)];
//    
//    RACUseDelegateProxy(self);
//    
//    return signal;
